...
//Event Object FOR PUBLISHER SUBSCRIBER OF CONVERSION OF TEMPERATURE
let events={
    events:{},
...
//CHECKING IF FAVOURITE IS IN LOCAL STORAGE
...
//TRYING TO SEARCH BASED ON USER LOCATION
...
//Fucntion to seacrh current and predicted weather
...
function addCityToFavouriteList(cityName,cityTemperature){
        ...
        //To resolve whether it is called by favourite clicked function.If not it will not push(for preventing duplicate items to be in array
